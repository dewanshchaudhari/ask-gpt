    ...
    return <>
        ...
        <main className="max-w-6xl mx-auto pt-10 pb-36 px-8">
            ...
            <div className="max-w-md mx-auto mb-14 text-center">
                ...
                <p className="text-xl text-gray-500 font-medium">Each query that you do uses one credit</p>
            </div>
                ...
                <div className="w-full flex-1 mt-8 p-8 order-2 bg-white shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-1 lg:rounded-r-none">
                    <div className="mb-7 pb-7 flex items-center border-b border-gray-300">
                        ...
                        <div className="ml-5">
                            ...
                            <span><span className="font-medium text-gray-500 text-xl align-top">$&thinsp;</span><span className="text-3xl font-bold">1 </span></span><span className="text-gray-500 font-medium">/ 50 Credits</span>
                        </div>
                    </div>
                ...
                <div className="w-full flex-1 p-8 order-1 shadow-xl rounded-3xl bg-gray-900 text-gray-400 sm:w-96 lg:w-full lg:order-2 lg:mt-0">
                    <div className="mb-8 pb-8 flex items-center border-b border-gray-600">
                        ...
                        <div className="ml-5">
                            ...
                            <span><span className="font-medium text-xl align-top">$&thinsp;</span><span className="text-3xl font-bold text-white">2 </span></span><span className="font-medium">/ 150 Credits</span>
                        </div>
                    </div>
                ...
                <div className="w-full flex-1 mt-8 p-8 order-3 bg-white shadow-xl rounded-3xl sm:w-96 lg:w-full lg:order-3 lg:rounded-l-none">
                    <div className="mb-7 pb-7 flex items-center border-b border-gray-300">
                        ...
                        <div className="ml-5">
                            ...
                            <span><span className="font-medium text-gray-500 text-xl align-top">$&thinsp;</span><span className="text-3xl font-bold">5 </span></span><span className="text-gray-500 font-medium">/ 500 Credits</span>
                        </div>
                    </div>
                    <ul className="mb-7 font-medium text-gray-500">
                        <li className="flex text-lg mb-2">
